         ...
         <li key={i} className="chatlogs-left-li">
           ...
           <Link className="chatlogs-left-li-button"
             to={`/chatlogs/${chats._id}/user/${
               ...
               onClick={() => {handleReadingMessages(chats.messages[chats.messages.length-1]._id)}}
             ...
             {chats?.participants[0]?.username === user.username
...

              {
               ...
               </div>
               {
                 ...
                 chats.messages[chats.messages.length-1].read === false &&   ( <div className="chat-unread-dot">
