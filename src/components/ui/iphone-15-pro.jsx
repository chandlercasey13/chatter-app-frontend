  ...
  return (
    (<svg
      ...
      <path
        ...
        className="fill-[#bde0fc] dark:fill-[#404040]" />
      <path
      ...
      <path
        ...
        className="fill-[#bde0fc] stroke-[#E5E5E5] stroke-[0.5] dark:fill-[#404040] dark:stroke-[#404040]" />
      {src && (
        <image
          href={src}
          x="21.25"
      ...
      <path
        ...
        className="fill-[#bde0fc] dark:fill-[#262626]"
